...
import BecomeAPartner from '../../components/Buttons/BecomeAPartner';

import Frame4729 from '../../assets/PartnerWithUsPages/Rectangle 4731.png';
...
function Partner() {
  return (
    <section className="flex flex-col items-start  md:mt-10 lg:items-center">
      <div className=" flex flex-col gap-[40px] p-4  bg-white md:flex-row md:gap-[34px] md:p-2 lg:flex-row  lg:p-8">
        <div>

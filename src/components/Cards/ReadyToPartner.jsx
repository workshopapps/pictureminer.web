  ...
  return (
    <div className="bg-white flex flex-col text-center items-center w-[425px] pt-[100px] pb-[100px] gap-[40px] md:w-[768px] lg:w-[1024px]  ">
      <div className="flex flex-col items-center w-[333px]  ">
        ...
        <p className=" text-[#1D1D1D] text-[12px] leading-[18px] font-normal font-sans   md:text-[14px] md:leading-[20px] md:w-[666px] md:h-[20px]  lg:w-[666px] lg:h-[24px] lg:text-[16px] lg:leading-[24px] ">Join our diverse stream of partners and start expanding!</p>
      </div>
      <Apply/>
    </div>
  );

...
const DemoPage = ({ heading, info_heading1, info_heading2, info_heading3,info_heading4,info_heading5, info_description1,info_description2,info_description3,info_description4,info_description5 }) => {
  return (
    <div className='py-10'>

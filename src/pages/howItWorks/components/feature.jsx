...
function Feature({ title, text, image, idx }) {
  return (
    <div className="md:odd:bg-[#D2D2D2]/20 odd:py-11 px-[74px] md:pl-[104px] md:pr-[81px] lg:px-[188px] flex odd:flex-row-reverse flex-row gap-y-7 md:gap-0 items-center justify-center md:gap-x-12 lg:gap-x-[109px]">

...
export default function Cards() {
    ...
    return(
        <div className='cards grid grid-cols-2 [&>*:nth-child(3)]:col-span-2 gap-4 lg:[&>*:nth-child(3)]:w-[30%] max-[768px]:[&>*:nth-child(3)]:w-[50%] max-[768px]:p-2'>
            {Card.map((card, index)=>{
                return(
            <div className='shadow-2xl p-5 max-[480px]:p-2  justify-center text-center lg:w-[50%] m-auto' key={index}>
                <img src={card.image} alt='icon' className='m-auto'/>
                <p className='text-[#49486B] font-bold max-[480px]:text-[12px]'>{card.name}</p>

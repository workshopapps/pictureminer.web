...
const Signup = () => {
  ...
  const {
    state: {
      signup: { loading, success, serverResponse, error },
    },
    dispatch,
  } = useGlobalContext();
  ...
  useEffect(() => {
    console.log({ loading, success, serverResponse, error });
  }, [loading, success, serverResponse, error]);

  const successs = true;
  if (successs) {
    return (
      <main className=" font-axiforma border border-red-500 border border-[#434343] rounded-[12px] w-[95%] max-w-[664px] flex flex-col  mx-auto my-[5rem] text-center px-4 items-center py-10  md:h-[500px]  justify-center gap-4">
  ...
  return (
    <main className=" font-axiforma border border-red-500 border border-[#434343] rounded-[12px] w-[95%] max-w-[664px] flex flex-col  mx-auto my-[5rem]">

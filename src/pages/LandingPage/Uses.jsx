    ...
    <section className='uses'>
      ...
      <div className='uses_benefits'>
        <div className='uses_benefit'>
          <img src={images.message} className='benefit_icon' alt="message icon" />
          <h3 className='benefit_heading'>
            Automated Answers
          </h3>
        ...
        <div className='uses_benefit'>
          <img src={images.userTick} className='benefit_icon' alt="usertick icon" />
          <h3 className='benefit_heading'>
            Easy to Use
          </h3>
          <p className='benefit_paragraph'>
        ...
        <div className='uses_benefit'>
          <img src={images.searchStatus} className='benefit_icon' alt="searchstatus icon" />
          <h3 className='benefit_heading'>
            Precise Search
          </h3>
          <p className='benefit_paragraph'>

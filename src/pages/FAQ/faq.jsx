  ...
  return (
    <>
      <div className="mt-14 md:px-28 container mb-10 md:mb-20 md:mt20">
        <h3 className="text-2xl py-3 md:text-3xl font-bold text-center">
        ...
        focus:outline-none"
              >
                <AccordionItemButton className="flex justify-between">
                  What is Minergram? <BsChevronDown />
                </AccordionItemButton>
              </AccordionItemHeading>
              <AccordionItemPanel>
                <p className="text-base px-5 md:text-lg">
                  ...
                  requests and responses. For an overview of how to use
                  Minergram, check out our brief tutorial
                  (minergram.com/how-to-use)
                </p>
              </AccordionItemPanel>
            </AccordionItem>
            <AccordionItem className="accordion-item bg-white border border-gray-200">
        ...
        focus:outline-none"
              ...
              <AccordionItemPanel className="text-base md:text-lg">
                <p className="text-base px-5 md:text-lg">
                  ...
                  technology (
                  <Link className="text-base md:text-lg" to="/support">
        ...
        focus:outline-none"
              ...
              <AccordionItemPanel className="text-base md:text-lg">
                <p className="text-base px-5 md:text-lg">
                  ...
                  <Link to="/pricing">minergram.com/paid-vers</Link>) of
                  Minergram for commercial use, which allows you to make bulk
                  searches. The commercial version of Minergram includes a user
                  interface for easy searching, as well as an API for
                  integrating Minergram with your own website or system. If you
        ...
        focus:outline-none"
              >
                <AccordionItemButton className="flex justify-between">
                  Can I use Minergram’s image recognition technologies with my
                  own images?
                  <BsChevronDown />
                </AccordionItemButton>
              </AccordionItemHeading>
              <AccordionItemPanel className="text-base md:text-lg">
                <p className="text-base px-5 md:text-lg">
                  Yes. We have a set of image recognition APIs that work with
                  your own image collections. You can find out more about our
                  APIs by visiting our technology/documentation page.
                </p>
              </AccordionItemPanel>
            </AccordionItem>
            <AccordionItem className="accordion-item bg-white border border-gray-200">
        ...
        focus:outline-none"
              ...
              <AccordionItemPanel className="text-base md:text-lg">
                <p className="text-base px-5 md:text-lg">
                  From the dashboard, you can upload an image, paste an image,
                  or point to a web image by typing or pasting it in a URL. You
                  can also use our Drag &amp; Drop feature.
                </p>
              </AccordionItemPanel>
            </AccordionItem>
            <AccordionItem className="accordion-item bg-white border border-gray-200">
        ...
        focus:outline-none"
              ...
              <AccordionItemPanel className="text-base md:text-lg">
                <p className="py-3 text-base px-5 md:text-lg">
                  File type: ToZilla accepts a variety of formats, including,
                  but not limited to, JPEG, PNG, GIF, BMP, TIFF, and WebP
                  images.
                </p>
                <p className="py-3 text-base px-5 md:text-lg">
                ...
                <p className="py-3 text-base px-5 md:text-lg">
                  Watermarked images: For best results, visibly watermarked
                  images should be avoided as ToZilla may search for the
                  watermark and not the image itself.
                </p>
                <p className="py-3 text-base px-5 md:text-lg">
                  Subject matter: Submitted images must adhere to our Terms of
                  Service (
                  <Link className="text-base md:text-lg" to="/terms-of-use">
                    minergram.com/termservice
                  </Link>
                  ).
                </p>
              </AccordionItemPanel>
        ...
        focus:outline-none"
              ...
              <AccordionItemPanel className="text-base md:text-lg">
                <p className="text-base px-5 md:text-lg">
                  ...
                  (minergram.com/contact-us) and one of our reps will be happy
                  to help.
                </p>
              </AccordionItemPanel>
            </AccordionItem>
        ...
        focus:outline-none"
              ...
              <AccordionItemPanel className="text-base md:text-lg">
                <p className="py-3 text-base px-5 md:text-lg">
                  ...
                  dashboard. Minergram processes millions of new images every
                  day, but your images belong to you.
                </p>
                <p className="py-3 text-base px-5 md:text-lg">
        ...
        focus:outline-none"
              >
                <AccordionItemButton className="flex justify-between">
                  {' '}
                  How can I use Minergram to find the copyright owner of an
                  image?
                  <BsChevronDown />
                </AccordionItemButton>
              </AccordionItemHeading>
              <AccordionItemPanel className="text-base md:text-lg">
                <p className="text-base px-5 md:text-lg">
                  Minergram doesn’t directly provide information on the owners
                  of an image’s copyright. You may find websites that are more
                  likely to contain ownership information.
                </p>
              </AccordionItemPanel>
            </AccordionItem>
            <AccordionItem className="accordion-item bg-white border border-gray-200">
        ...
        focus:outline-none"
              ...
              <AccordionItemPanel className="text-base md:text-lg">
                <p className="text-base px-5 md:text-lg">
                  Removing your images from ToZilla is easy and hassle-free.
                  Just select the files you want to remove and click the delete
                  button. This image(s) is then removed from ToZilla servers.
                </p>
                <p className="text-base px-5 md:text-lg">
                  If your image appears anywhere else on the web and you want it
                  removed, you should contact the webmaster of the site where
                  that image appears.
                </p>
              </AccordionItemPanel>
            </AccordionItem>

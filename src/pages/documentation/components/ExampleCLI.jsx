...
function ExampleCLI({ setTabState }) {
  return (
    <section className="">
      ...
      <div className="mx-8 md:mx-10 lg:mx-20 md:flex md:space-x-8 mt-10 lg:mt-20">
        <div className="md:w-9/12 lg:w-3/5 ">
          <div>
            <h2 className="text-large font-bold">Examples of using the CLI</h2>
            <p className="mt-5 text-normal">
              Simplest way to test our API is calling through a CLI
              prerequisites
            </p>
            <ul className="mt-6 list-disc">
              <li className="ml-8">You must have an account</li>
              <li className="ml-8">A computer with internet access</li>
            </ul>
          </div>
          <div className="mt-16 md:mt-20 lg:mt-[100px]">
            <h2 className="text-large font-bold">Login</h2>
            <div className="md:flex md:flex-col mt-5 space-y-10 md:space-y-12 2xl:pr-20">
              <div className="space-y-8 ">
                <div className="">
                  <p className="mt-2">
                    To get a JWT access token you have to first make a login
                    request with your signup credentials to make a URL request,

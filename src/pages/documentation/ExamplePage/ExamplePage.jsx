...
const ExamplePage = () => {
  return (
    <div className="example_wrapper">
      ...
      <DocumentationHero
        headerText="Examples"
        paragraphText="An overview of Discripto's usage with examples"
      />
      <section className="example_introductionContent" id="example">
        <div className="example_mainContent">
          ...
          <p className="example_paragraph">
            Get started with Discripto’s usage with examples
          </p>
          <div className="example_overview" id="overview">
            ...
            <p className="mb-3">
              ...
              test key and data. Get started with Discripto’s usage with
              examples
            </p>
          </div>
          <div className="example_overview" id="overview">

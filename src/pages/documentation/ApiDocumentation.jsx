  ...
  return (
    <div className="">
      ...
      <div className="bg-[#FAFAFB] ">
        <p className="max-w-[1272px] mx-auto text-[#061D33]">
          Documentation/API
        </p>
      </div>
      <div className="grid grid-cols-[4fr,1fr] max-w-[1272px] mx-auto">
        <div className="w-[772px]  ">
          <section id="introduction">
            <h2 className="text-[#051626] text-[36px] font-medium leading-[50px] mt-4">
              Introduction
            </h2>
            <hr className="my-4" />
            <p className="text-2xl text-[#092C4C] leading-[35px]">
          ...
          <section id="overview" className="py-12">
            ...
            <p className="mt-12 leading-[30px] text-xl text-[#1D1D1D]">
          ...
          <section id="metadata" className="py-12">
            <h2 className="text-[#1D1D1D] text-[30px] font-medium leading-[42px]">
              Metadata
            </h2>
            <p className="mt-12 leading-[30px] text-xl text-[#1D1D1D]">

  ...
  return (
    <div className="font-axiforma ">
      ...
      <div className="bg-[#FAFAFB] hidden sm:block">
        <p className="max-w-[1272px] mx-auto text-[#061D33] py-4 px-10">
          Documentation/API
        </p>
      </div>
      <div className="grid grid-cols-[4fr,1fr] max-w-[1272px] mx-auto px-8">
        <div className="sm:w-[538px] xl:w-[772px]  ">
          <section id="introduction">
            <h2 className="text-[#051626] text-[16px] sm:text-[36px] font-medium leading-[50px] mt-6 sm:mt-4">
              Introduction
            </h2>
            <hr className="my-4 hidden sm:block" />
            <p className="text-[24px] text-[#092C4C] leading-[35px] hidden sm:block">
              Get started with Minergram API and explore various benefits and
              uses
            </p>
          </section>
          <section id="overview" className="py-6 sm:py-12">
            <h2 className="text-[#1D1D1D] text-[12px] sm:text-[30px] font-medium leading-[42px] hidden sm:block">
              Overview
            </h2>
            <p className="mt-6 sm:mt-12 leading-[30px] text-[12px] sm:text-[20px] text-[#1D1D1D]">
          ...
          <section id="authentication" className="py-6 sm:py-12">
            <h2 className="text-[#1D1D1D] text-[16px] sm:text-[30px] font-medium leading-[42px]">
              Authentication
            </h2>
            <p className="mt-6 sm:mt-12 leading-[30px] text-[12px] sm:text-[20px] text-[#1D1D1D]">

          ...
          <div className="w-5/6 md:w-2/4 lg:w-4/12 p-6 flex flex-col items-center justify-center text-center bg-white absolute rounded-md top-2/4 left-2/4 -translate-x-2/4 -translate-y-2/4 ">
            ...
            <div className="mt-5">
              ...
              <p className="text-sm text-inputGray mt-2">
                ...
                like to proceed with the cancelling of your tozilla basic plan,
                select &#8220;Cancel plan&#8220;below.
              </p>
            </div>
            <div className="mt-8 flex flex-col space-y-4 md:space-y-0 w-full md:flex-row md:space-x-4">
              <Button
                type="button"
                text="Undo"
                className={`py-2 rounded-lg text-small font-medium border border-mainOrange border-solid w-full text-mainOrange`}
                onclick={toggleCancelPlanModal}
              ></Button>
              <Button
                type="button"
                text="Cancel plan"
                className={`py-2 rounded-lg text-small font-medium border bg-mainOrange w-full text-white`}

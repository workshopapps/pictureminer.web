const terms = [
  ...
  {
    text: 'Violate the privacy of any third party, such as by posting another person\'s personal data without consent; or use scraping to extract data from our Services via an automated process.',
  },
];

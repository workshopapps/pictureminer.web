...
const feedbackpar = `If you send or transmit any communications or materials to us by mail,
          ...
          suggestions, or the like ("Feedback"), we are free to use such
          Feedback irrespective of any other obligation or limitation between
          you and us governing such Feedback. You hereby assign to us, all
          right, title, and interest in, and agree to provide us any assistance
          we require to document, perfect, and maintain our rights. We are free
          to use, without any attribution or compensation to any party, any
          ideas, know-how, concepts, techniques, or other intellectual property
          rights contained in the Feedback, for any purpose whatsoever, although
          we are not required to use any Feedback.`;

export { secondparp1, servicespar2, feedbackpar };
